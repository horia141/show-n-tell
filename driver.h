...
typedef struct _linesmgr  linesmgr;
...
linesmgr*         driver_linesmgr_make(driver* drv);
void              driver_linesmgr_free(driver* drv, lines_mgr* lm);
...
bool              linesmgr_is_valid(const linesmgr* lm);

void              linesmgr_add_line_full(linesmgr* lm, float sx, float sy, float ex, float ey);
void              linesmgr_add_line_point(linesmgr* lm, const point* p);
